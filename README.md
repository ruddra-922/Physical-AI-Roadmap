# Physical AI Resource Index [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

A community-focused index for **Physical AI**, built to help researchers, builders, students, and robotics enthusiasts discover important papers, projects, datasets, and companies shaping embodied intelligence.

> **Physical AI** is a growing community around AI systems that can understand the physical world, reason about it, and act through robots or other embodied machines.
...
<a id="vision-language-backbones"></a>

### Vision-Language Backbones

> Vision-language model families often used as perception and semantic grounding layers for embodied AI systems.
...
<a id="visual-representations"></a>

### Visual Representations

> Visual representation learners and perception modules commonly reused for robotic sensing pipelines.
...
<a id="vla-architectures"></a>

## VLA Architectures

<a id="end-to-end-vlas"></a>

### End-to-End VLAs

> Unified architectures where visual observations, language instructions, and robot actions are handled inside one policy stack.
...
> Systems that separate high-level reasoning or planning from lower-level motion generation and control.
...
<a id="compact--efficient-vlas"></a>

### Compact & Efficient VLAs

> Smaller VLA variants aimed at lower latency, cheaper inference, and deployment on constrained hardware.
...
<a id="discrete-tokenization"></a>

### Discrete Tokenization

> Methods that turn continuous robot commands into token-like action representations.
...
<a id="discrete-diffusion-vlas"></a>

### Discrete Diffusion VLAs

> Diffusion-style action-token generators that sample chunks in parallel rather than step-by-step autoregression.
...
<a id="continuous--diffusion-policies"></a>
...
<a id="jepa--latent-prediction"></a>

### JEPA & Latent Prediction

> JEPA-style approaches forecast latent state representations instead of reconstructing raw pixels.
...
<a id="generative-world-models"></a>

### Generative World Models

> Generative models for simulating future frames, video dynamics, or interactive virtual environments.
...
<a id="embodied-world-models"></a>

### Embodied World Models

> World-model approaches tailored to manipulation, movement, navigation, and physical interaction.
...
<a id="chain-of-thought--deliberation"></a>

### Chain-of-Thought & Deliberation

> Policies that add deliberation, intermediate reasoning, search, or value estimates before acting.
...
<a id="error-detection--recovery"></a>

### Error Detection & Recovery

> Techniques that identify execution errors and adjust robot behavior during task performance.
...
> Demonstration-driven learning methods, including behavior cloning and imitation pipelines.
...
> Reinforcement-learning approaches for improving embodied or VLA policies beyond supervised imitation.
...
> Language-model-assisted reward design and task specification for robot learning.
...
> Empirical scaling relationships between data, model capacity, embodiment diversity, and robot performance.
...
<a id="cross-embodiment-transfer"></a>

### Cross-Embodiment Transfer

> General policies designed to transfer across different bodies, sensors, and action spaces.
...
<a id="open-vocabulary-generalization"></a>

### Open-Vocabulary Generalization

> Approaches targeting unseen objects, new appearances, and open-vocabulary task conditions.
...
<a id="quantization--compression"></a>

### Quantization & Compression

> Compression and quantization work that reduces memory or compute cost for deployment.
...
<a id="real-time-control"></a>

### Real-Time Control

> Control strategies that reconcile slower foundation-model inference with fast robot actuation loops.
...
> Safety, bias, alignment, and policy constraints for robots acting around people and physical environments.
...
> Continual-learning systems that accumulate new skills while retaining earlier capabilities.
...
> Foundation-model approaches focused on whole-body humanoid control and loco-manipulation.
...
> Manipulation research using large pretrained models, learned policies, or multimodal representations.
...
> Navigation systems that combine visual perception, language goals, and embodied decision-making.
...
> Sim-to-real methods that improve transfer from synthetic training environments to physical robots.
...
> Survey papers, taxonomies, and review articles covering embodied AI, VLAs, world models, and robot learning.
...
> Adjacent curated lists and reference collections for robotics, world models, and embodied intelligence.
...
If this index helps your research or project work, you can reference the repository as follows:
...
Contributions are welcome. Open a pull request for relevant additions, corrections, link fixes, or structural improvements.
